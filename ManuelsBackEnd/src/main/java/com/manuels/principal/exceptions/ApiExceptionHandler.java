...
public class ApiExceptionHandler{
    ...
    // exception handler dispara todas las clases java que requeramos
    // asocia not found status a not found exception
    ...
    // no soporta mensajes en el cuerpo (unauthorized)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ExceptionHandler({
        UnauthorizedException.class,
        //org.springframework.security.access.AccessDeniedExcception.class
    })
