...
/* LIMITAR INICIOS DE SESION!!! !!!  ! !*/
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/api/lessons").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/lessons").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/lessons").permitAll()
                
                .antMatchers(HttpMethod.GET, "/api/dates").permitAll()
                .antMatchers(HttpMethod.POST, "/api/dates").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/dates").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/dates").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/publications/").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/publications/").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/publications/").permitAll()
